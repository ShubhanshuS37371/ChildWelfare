...
import { OMNIDEF } from './fosterCareIntakeEnglish_def.js';
import tmpl from './fosterCareIntakeEnglish.html';
import tmpl_nds from './fosterCareIntakeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fosterCareIntakeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
