...
import { OMNIDEF } from './cCWISTANFEligiblityDeterminationEnglish_def.js';
import tmpl from './cCWISTANFEligiblityDeterminationEnglish.html';
import tmpl_nds from './cCWISTANFEligiblityDeterminationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCWISTANFEligiblityDeterminationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
