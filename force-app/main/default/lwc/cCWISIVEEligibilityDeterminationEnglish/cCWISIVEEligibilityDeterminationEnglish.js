...
import OmniscriptHeader from 'vlocity_ps/omniscriptHeader';
import { isOffPlatform, setConnection, getConnection } from 'vlocity_ps/omniscriptRestApi';
import { RUN_MODES, registerNs } from 'vlocity_ps/omniscriptInternalUtils';
import { OMNIDEF } from './cCWISIVEEligibilityDeterminationEnglish_def.js';
import tmpl from './cCWISIVEEligibilityDeterminationEnglish.html';
import tmpl_nds from './cCWISIVEEligibilityDeterminationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCWISIVEEligibilityDeterminationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
